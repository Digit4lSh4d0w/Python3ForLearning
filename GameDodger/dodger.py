...
pygame.display.set_caption('Писосич')
...
drawText('Писосич', font, windowSurface, (WINDOWWIDTH / 3), (WINDOWHEIGHT / 3))
drawText('Нажмите любую клавишу для начала игры', font, windowSurface, (WINDOWWIDTH / 9) - 30, (WINDOWHEIGHT / 3) + 50)
